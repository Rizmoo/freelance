...
class CountriesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $countries = [
            ...
            ['name' => 'Bhutan', 'abbr' => 'BT'],
            ['name' => 'Bolivia, Plurinational State of', 'abbr' => 'BO'],
            ['name' => 'Bonaire, Sint Eustatius and Saba', 'abbr' => 'BQ'],
            ...
            ['name' => 'Guyana', 'abbr' => 'GY'],
            ['name' => 'Haiti', 'abbr' => 'HT'],
            ['name' => 'Heard Island and McDonald Mcdonald Islands', 'abbr' => 'HM'],
            ...
            ['name' => 'Saint Helena, Ascension and Tristan da Cunha', 'abbr' => 'SH'],
            ['name' => 'Saint Kitts and Nevis', 'abbr' => 'KN'],
            ['name' => 'Saint Lucia', 'abbr' => 'LC'],
            ['name' => 'Saint Martin (French part)', 'abbr' => 'MF'],
            ...
            ['name' => 'Sint Maarten (Dutch part)', 'abbr' => 'SX'],
            ...
            ['name' => 'Venezuela, Bolivarian Republic of', 'abbr' => 'VE'],
